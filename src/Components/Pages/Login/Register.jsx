  ...
  const handleRegister = (event) => {
    ...
    if (
      !/^(?=.*\d)(?=.*[A-Z])(?=.*[a-z])(?=.*[a-zA-Z!#$%&? "])[a-zA-Z0-9!#$%&?]{8,20}$/.test(
        ...
        setError('Min 8 char,one uppercase, one lowercase,one digit and one special character please include');
        return;
    }
        ...
        <div className="mb-4">
          <div className="flex items-center">
            <input
              ...
              required
            />
            <label className="text-gray-700 font-bold" htmlFor="accept">
              Accept{" "}
              <Link className="text-blue-500 hover:underline" to="/terms">
